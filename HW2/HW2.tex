...
\item [12.2] % for 0.1, 1, 10, and 100Mo stars
	...
	\item 
        I used the following equations for timescales:
        \begin{align}
        \tau_\mathrm{Hayashi} &= 10^6  \left( \frac{M}{\msol} \right)^{-1} \mathrm{\ yr} \\
        \tau_\mathrm{PMS} &= 6 \times 10^7 \left( \frac{M}{\msol} \right)^{-2.5}  \mathrm{\ yr}
        \end{align}
    	\begin{table}[H]
        \centering
        \begin{tabular}{ r | c | c }
